---
title: "Understanding Bantu-Sphere Transaction Fees"
summary: "Learn about our transparent fee structure and how we keep transaction costs low for our users."
...
Bantu-Sphere is committed to providing transparent and affordable transaction fees. Our fee structure is designed to be simple, predictable, and competitive in the digital wallet market.

## Fee Structure

- **Domestic Transfers**: Free for transfers within the same country
- **International Transfers**: 1.5% or minimum $0.50, whichever is higher
- **Currency Exchange**: Real-time market rates with no hidden markups
- **Wallet Maintenance**: No monthly or annual fees for keeping your wallet active
